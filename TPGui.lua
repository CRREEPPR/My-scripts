-- TP Location GUI Script (Updated V5.36)
-- Technical Implementation: Added ResetOnSpawn = false to ensure persistence through character deaths.
...
local screenGui = Instance.new("ScreenGui", guiParent); screenGui.Name = "TPGui"; screenGui.ResetOnSpawn = false
