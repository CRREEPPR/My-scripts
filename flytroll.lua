...
local function createGUI()
    ...
    local title = Instance.new("TextLabel", frame); title.Text = "fly troll V5.30"; title.Size = UDim2.new(0.8, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1
    ...
    RS.RenderStepped:Connect(function()
        ...
        if infJump and UIS:IsKeyDown(Enum.KeyCode.Space) and player.Character then player.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Jumping) end
    end)
end
createGUI()
