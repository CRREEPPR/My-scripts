...
local function createGUI()
    ...
    local frame = Instance.new("Frame", screenGui); frame.Size = UDim2.new(0, 180, 0, 380); frame.Position = UDim2.new(0.1, 0, 0.1, 0); frame.BackgroundColor3 = Color3.fromRGB(30, 30, 30); makeDraggable(frame)
    local title = Instance.new("TextLabel", frame); title.Text = "Fly troll V5.18"; title.Size = UDim2.new(0.8, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1; title.Font = Enum.Font.SourceSansBold
    ...
    local container = Instance.new("ScrollingFrame", frame); container.Size = UDim2.new(1, 0, 1, -30); container.Position = UDim2.new(0, 0, 0, 30); container.BackgroundTransparency = 1; container.CanvasSize = UDim2.new(0,0,2.1,0); container.ScrollBarThickness = 4
    ...
    local speedBox = Instance.new("TextBox", container); speedBox.Text = "50"; speedBox.PlaceholderText = "Fly Speed (1-10000)"; speedBox.Size = UDim2.new(0.9, 0, 0, 40); speedBox.BackgroundColor3 = Color3.fromRGB(50,50,50); speedBox.TextColor3 = Color3.new(1,1,1); speedBox.LayoutOrder = 5
    local bgBtn = Instance.new("TextButton", container); bgBtn.Text = "Background Color"; bgBtn.Size = UDim2.new(0.9, 0, 0, 40); bgBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); bgBtn.TextColor3 = Color3.new(1,1,1); bgBtn.LayoutOrder = 6
    local btnBtn = Instance.new("TextButton", container); btnBtn.Text = "Buttons Color"; btnBtn.Size = UDim2.new(0.9, 0, 0, 40); btnBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); btnBtn.TextColor3 = Color3.new(1,1,1); btnBtn.LayoutOrder = 7
    local txtBtn = Instance.new("TextButton", container); txtBtn.Text = "Text Color"; txtBtn.Size = UDim2.new(0.9, 0, 0, 40); txtBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); txtBtn.TextColor3 = Color3.new(1,1,1); txtBtn.LayoutOrder = 8
    ...
    local colorPalette = {Color3.new(1,1,1), Color3.new(0,0,0), Color3.new(0.5,0.5,0.5), Color3.new(0.2,0.2,0.2), Color3.new(1,0,0), Color3.new(0,1,0), Color3.new(0,0,1), Color3.new(1,1,0), Color3.new(1,0,1), Color3.new(0,1,1), Color3.fromRGB(255,165,0), Color3.fromRGB(128,0,128), Color3.fromRGB(255,105,180), Color3.fromRGB(0,255,127), Color3.fromRGB(135,206,235), Color3.fromRGB(255,69,0), Color3.fromRGB(75,0,130), Color3.fromRGB(240,230,140), Color3.fromRGB(46,139,87), Color3.fromRGB(220,20,60), Color3.fromRGB(255,215,0), Color3.fromRGB(0,191,255), Color3.fromRGB(154,205,50), Color3.fromRGB(218,112,214), Color3.fromRGB(255,127,80), Color3.fromRGB(0,0,139), Color3.fromRGB(139,0,0), Color3.fromRGB(0,100,0), Color3.fromRGB(255,255,240), Color3.fromRGB(250,235,215), Color3.fromRGB(173,216,230), Color3.fromRGB(255,182,193), Color3.fromRGB(144,238,144), Color3.fromRGB(255,250,205), Color3.fromRGB(230,230,250), Color3.fromRGB(255,0,255), Color3.fromRGB(0,255,0), Color3.fromRGB(0,255,255), Color3.fromRGB(255,255,0), Color3.fromRGB(192,192,192)}
    ...
    -- Button Logic
    minBtn.MouseButton1Click:Connect(function() minimized = not minimized; container.Visible = not minimized; frame.Size = minimized and UDim2.new(0, 180, 0, 30) or UDim2.new(0, 180, 0, 380); minBtn.Text = minimized and "^" or "v" end)
