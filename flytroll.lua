...
local function createGUI()
    ...
    colorGui.Size = UDim2.new(0, 150, 0, 280); colorGui.Position = UDim2.new(0.3, 0, 0.1, 0); colorGui.Visible = false; colorGui.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    ...
    local colorList = {{"Blue", Color3.new(0,0,1)}, {"Yellow", Color3.new(1,1,0)}, {"Red", Color3.new(1,0,0)}, {"Green", Color3.new(0,1,0)}, {"White", Color3.new(1,1,1)}, {"Black", Color3.new(0,0,0)}, {"Cyan", Color3.fromRGB(0,255,255)}, {"Pink", Color3.fromRGB(255,105,180)}, {"Purple", Color3.fromRGB(128,0,128)}}
    for i, v in pairs(colorList) do
        local btn = Instance.new("TextButton", colorGui); btn.Text = v[1]; btn.Size = UDim2.new(1, 0, 0, 30); btn.Position = UDim2.new(0, 0, 0, (i-1)*30); btn.MouseButton1Click:Connect(function() applyColor(v[2]) end)
    end
    ...
    local flyBtn = Instance.new("TextButton", container); flyBtn.Text = "Toggle Fly"; flyBtn.Size = UDim2.new(1, 0, 0, 30)
