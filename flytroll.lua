...
local function createGUI()
    ...
    local title = Instance.new("TextLabel", frame); title.Text = "Fly troll by abd55_55 V4.8"; title.Size = UDim2.new(0.8, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1
    ...
    for _, col in pairs({Color3.new(1,1,1), Color3.new(0,0,1), Color3.fromRGB(255,165,0), Color3.new(1,1,0), Color3.new(1,0,0), Color3.new(0,1,0), Color3.new(0,0,0), Color3.fromRGB(0,255,255), Color3.fromRGB(255,105,180), Color3.fromRGB(128,0,128)}) do
