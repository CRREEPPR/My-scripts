...
local function createGUI()
    ...
    colorGui.Size = UDim2.new(0, 150, 0, 340); colorGui.Position = UDim2.new(0.3, 0, 0.1, 0); colorGui.Visible = false; colorGui.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    ...
    local colorList = {{"Rainbow", "Rainbow"}, {"Blue", Color3.new(0,0,1)}, {"Orange", Color3.fromRGB(255,165,0)}, {"Yellow", Color3.new(1,1,0)}, {"Red", Color3.new(1,0,0)}, {"Green", Color3.new(0,1,0)}, {"White", Color3.new(1,1,1)}, {"Black", Color3.new(0,0,0)}, {"Cyan", Color3.fromRGB(0,255,255)}, {"Pink", Color3.fromRGB(255,105,180)}, {"Purple", Color3.fromRGB(128,0,128)}}
    for i, v in pairs(colorList) do
        ...
        btn.MouseButton1Click:Connect(function() 
            rainbowEnabled = (v[1] == "Rainbow")
            if not rainbowEnabled then
                if colorTarget == "Background" then frame.BackgroundColor3 = v[2]
                else for _, c in pairs(container:GetChildren()) do if c:IsA("TextButton") or c:IsA("TextBox") then c.BackgroundColor3 = v[2] end end end
            end
