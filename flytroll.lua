...
local function createGUI()
    ...
    local frame = Instance.new("Frame", screenGui); frame.Size = UDim2.new(0, 180, 0, 470); frame.Position = UDim2.new(0.1, 0, 0.1, 0); frame.BackgroundColor3 = Color3.fromRGB(30, 30, 30); makeDraggable(frame)
    local title = Instance.new("TextLabel", frame); title.Text = "Fly troll V5.17"; title.Size = UDim2.new(0.8, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1; title.Font = Enum.Font.SourceSansBold
    ...
    local container = Instance.new("ScrollingFrame", frame); container.Size = UDim2.new(1, 0, 1, -30); container.Position = UDim2.new(0, 0, 0, 30); container.BackgroundTransparency = 1; container.CanvasSize = UDim2.new(0,0,2.6,0); container.ScrollBarThickness = 4
    ...
    local speedBox = Instance.new("TextBox", container); speedBox.Text = "50"; speedBox.PlaceholderText = "Fly Speed (1-10000)"; speedBox.Size = UDim2.new(0.9, 0, 0, 40); speedBox.BackgroundColor3 = Color3.fromRGB(50,50,50); speedBox.TextColor3 = Color3.new(1,1,1); speedBox.LayoutOrder = 6
    local powerBox = Instance.new("TextBox", container); powerBox.Text = "500"; powerBox.PlaceholderText = "Fling Power (1-10000)"; powerBox.Size = UDim2.new(0.9, 0, 0, 40); powerBox.BackgroundColor3 = Color3.fromRGB(50,50,50); powerBox.TextColor3 = Color3.new(1,1,1); powerBox.LayoutOrder = 7
    local bgBtn = Instance.new("TextButton", container); bgBtn.Text = "Background Color"; bgBtn.Size = UDim2.new(0.9, 0, 0, 40); bgBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); bgBtn.TextColor3 = Color3.new(1,1,1); bgBtn.LayoutOrder = 8
    local btnBtn = Instance.new("TextButton", container); btnBtn.Text = "Buttons Color"; btnBtn.Size = UDim2.new(0.9, 0, 0, 40); btnBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); btnBtn.TextColor3 = Color3.new(1,1,1); btnBtn.LayoutOrder = 9
    local txtBtn = Instance.new("TextButton", container); txtBtn.Text = "Text Color"; txtBtn.Size = UDim2.new(0.9, 0, 0, 40); txtBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); txtBtn.TextColor3 = Color3.new(1,1,1); txtBtn.LayoutOrder = 10
    ...
    -- Button Logic
    minBtn.MouseButton1Click:Connect(function() minimized = not minimized; container.Visible = not minimized; frame.Size = minimized and UDim2.new(0, 180, 0, 30) or UDim2.new(0, 180, 0, 470); minBtn.Text = minimized and "^" or "v" end)
    ...
    flingBtn.MouseButton1Click:Connect(function()
        ...
        if root and hum then
            ...
            bv.Velocity = Vector3.new(math.random(-flingPower, flingPower), math.random(-flingPower, flingPower), math.random(-flingPower, flingPower))
            task.wait(0.5)
    ...
    powerBox.FocusLost:Connect(function() flingPower = math.clamp(tonumber(powerBox.Text) or 500, 1, 10000) end)
