...
local function createGUI()
    ...
    local title = Instance.new("TextLabel", frame); title.Text = "Fly Troll V5.20"; title.Size = UDim2.new(1, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1; title.Font = Enum.Font.SourceSansBold
    
    local container = Instance.new("ScrollingFrame", frame); container.Size = UDim2.new(1, 0, 1, -30); container.Position = UDim2.new(0, 0, 0, 30); container.BackgroundTransparency = 1; container.CanvasSize = UDim2.new(0,0,1.8,0); container.ScrollBarThickness = 4
    ...
    local speedBox = Instance.new("TextBox", container); speedBox.Text = "50"; speedBox.PlaceholderText = "Speed"; speedBox.Size = UDim2.new(0.9, 0, 0, 35); speedBox.BackgroundColor3 = Color3.fromRGB(60,60,60); speedBox.TextColor3 = Color3.new(1,1,1)
    local bgBtn = newBtn("Bg Color"); local btnBtn = newBtn("Btn Color"); local txtBtn = newBtn("Txt Color")
    ...
    local colorScroll = Instance.new("ScrollingFrame", colorGui); colorScroll.Size = UDim2.new(1, 0, 1, 0); colorScroll.BackgroundTransparency = 1; Instance.new("UIGridLayout", colorScroll).CellSize = UDim2.new(0, 35, 0, 35)
    
    local colorPalette = {
        Color3.fromRGB(20,20,20), Color3.fromRGB(40,40,40), Color3.fromRGB(60,60,60), Color3.fromRGB(80,80,80), Color3.fromRGB(100,100,100), Color3.fromRGB(120,120,120), Color3.fromRGB(140,140,140), Color3.fromRGB(160,160,160), Color3.fromRGB(180,180,180), Color3.fromRGB(200,200,200),
        Color3.new(1,0,0), Color3.new(0,1,0), Color3.new(0,0,1), Color3.new(1,1,0), Color3.new(1,0,1), Color3.new(0,1,1), Color3.new(1,1,1), Color3.new(0,0,0), Color3.fromRGB(255,165,0), Color3.fromRGB(128,0,128),
        Color3.fromRGB(255,20,147), Color3.fromRGB(0,255,127), Color3.fromRGB(135,206,235), Color3.fromRGB(255,69,0), Color3.fromRGB(75,0,130), Color3.fromRGB(240,230,140), Color3.fromRGB(46,139,87), Color3.fromRGB(220,20,60), Color3.fromRGB(255,215,0), Color3.fromRGB(0,191,255),
        Color3.fromRGB(154,205,50), Color3.fromRGB(218,112,214), Color3.fromRGB(255,127,80), Color3.fromRGB(0,0,139), Color3.fromRGB(139,0,0), Color3.fromRGB(0,100,0), Color3.fromRGB(255,250,205), Color3.fromRGB(230,230,250), Color3.fromRGB(255,0,255), Color3.fromRGB(192,192,192)
    }
