...
local function createGUI()
    ...
    local title = Instance.new("TextLabel", frame); title.Text = "Fly troll V5.15"; title.Size = UDim2.new(0.8, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1; title.Font = Enum.Font.SourceSansBold
    ...
    local noclipBtn = Instance.new("TextButton", container); noclipBtn.Text = "Noclip: OFF"; noclipBtn.Size = UDim2.new(0.9, 0, 0, 40); noclipBtn.BackgroundColor3 = Color3.fromRGB(50,50,50); freezeBtn.TextColor3 = Color3.new(1,1,1); noclipBtn.LayoutOrder = 4
    ...
    flingBtn.MouseButton1Click:Connect(function()
        ...
        if root and hum then
            ...
            bv.Velocity = Vector3.new(math.random(-5000, 5000), math.random(-5000, 5000), math.random(-5000, 5000))
            task.wait(0.5)
