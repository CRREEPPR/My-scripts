...
local function createGUI()
    ...
    local frame = Instance.new("Frame", screenGui); frame.Size = UDim2.new(0, 160, 0, 260); frame.Position = UDim2.new(0.1, 0, 0.1, 0); frame.BackgroundColor3 = Color3.fromRGB(40, 40, 40); makeDraggable(frame)
    local title = Instance.new("TextLabel", frame); title.Text = "Fly Troll V5.19"; title.Size = UDim2.new(1, 0, 0, 25); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1; title.Font = Enum.Font.SourceSansBold
    
    local container = Instance.new("ScrollingFrame", frame); container.Size = UDim2.new(1, 0, 1, -25); container.Position = UDim2.new(0, 0, 0, 25); container.BackgroundTransparency = 1; container.CanvasSize = UDim2.new(0,0,1.8,0); container.ScrollBarThickness = 4
    local layout = Instance.new("UIListLayout", container); layout.HorizontalAlignment = Enum.HorizontalAlignment.Center; layout.Padding = UDim.new(0, 4)

    local function newBtn(name) local b = Instance.new("TextButton", container); b.Text = name; b.Size = UDim2.new(0.9, 0, 0, 30); b.BackgroundColor3 = Color3.fromRGB(60,60,60); b.TextColor3 = Color3.new(1,1,1); return b end
    ...
    local speedBox = Instance.new("TextBox", container); speedBox.Text = "50"; speedBox.PlaceholderText = "Speed"; speedBox.Size = UDim2.new(0.9, 0, 0, 30); speedBox.BackgroundColor3 = Color3.fromRGB(60,60,60); speedBox.TextColor3 = Color3.new(1,1,1)
    local bgBtn = newBtn("Bg Color"); local btnBtn = newBtn("Btn Color"); local txtBtn = newBtn("Txt Color")

    local colorGui = Instance.new("Frame", screenGui); colorGui.Size = UDim2.new(0, 160, 0, 200); colorGui.Position = UDim2.new(0.3, 0, 0.1, 0); colorGui.Visible = false; colorGui.BackgroundColor3 = Color3.fromRGB(40, 40, 40); makeDraggable(colorGui)
    local colorScroll = Instance.new("ScrollingFrame", colorGui); colorScroll.Size = UDim2.new(1, 0, 1, 0); colorScroll.BackgroundTransparency = 1; Instance.new("UIGridLayout", colorScroll).CellSize = UDim2.new(0, 30, 0, 30)
    
    local colorPalette = {Color3.fromRGB(40,40,40), Color3.fromRGB(80,80,80), Color3.fromRGB(120,120,120), Color3.fromRGB(160,160,160), Color3.fromRGB(200,200,200), Color3.new(1,0,0), Color3.new(0,1,0), Color3.new(0,0,1), Color3.new(1,1,0)}
