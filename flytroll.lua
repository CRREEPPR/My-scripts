...
local function createGUI()
    ...
    local title = Instance.new("TextLabel", frame); title.Text = "Fly troll V4.9"; title.Size = UDim2.new(0.8, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1
    ...
    local bgBtn = Instance.new("TextButton", container); bgBtn.Text = "Background Color"; bgBtn.Size = UDim2.new(0.9, 0, 0, 40); bgBtn.Position = UDim2.new(0.05, 0, 0, 110)
    local btnBtn = Instance.new("TextButton", container); btnBtn.Text = "Buttons Color"; btnBtn.Size = UDim2.new(0.9, 0, 0, 40); btnBtn.Position = UDim2.new(0.05, 0, 0, 160)
    local speedBox = Instance.new("TextBox", container); speedBox.Text = "50"; speedBox.PlaceholderText = "Speed (1-10000)"; speedBox.Size = UDim2.new(0.9, 0, 0, 40); speedBox.Position = UDim2.new(0.05, 0, 0, 210)
    ...
    local colorPalette = {
        Color3.new(1,1,1), Color3.new(0,0,0), Color3.new(1,0,0), Color3.new(0,1,0), Color3.new(0,0,1),
        Color3.new(1,1,0), Color3.new(1,0,1), Color3.new(0,1,1), Color3.fromRGB(255,165,0), Color3.fromRGB(128,0,128),
        Color3.fromRGB(255,105,180), Color3.fromRGB(0,255,127), Color3.fromRGB(135,206,235), Color3.fromRGB(210,180,140), Color3.fromRGB(255,69,0),
        Color3.fromRGB(75,0,130), Color3.fromRGB(240,230,140), Color3.fromRGB(46,139,87), Color3.fromRGB(220,20,60), Color3.fromRGB(65,105,225)
    }
