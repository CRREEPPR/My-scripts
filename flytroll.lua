...
local function createGUI()
    ...
    local title = Instance.new("TextLabel", frame); title.Text = "fly troll V5.33"; title.Size = UDim2.new(0.8, 0, 0, 30); title.TextColor3 = Color3.new(1,1,1); title.BackgroundTransparency = 1
    ...
    addSet("Fly Spd", 50, function(v) flySpeed = v end); addSet("Walk Spd", 16, function(v) walkSpeed = v; if player.Character and player.Character:FindFirstChild("Humanoid") then player.Character.Humanoid.WalkSpeed = v end end); addSet("Jump Pwr", 50, function(v) jumpPower = v; if player.Character and player.Character:FindFirstChild("Humanoid") then player.Character.Humanoid.JumpPower = v end end)
    
    local bgBtn = Instance.new("TextButton", sScroll); bgBtn.Text = "BG Color"; bgBtn.Size = UDim2.new(0.9, 0, 0, 35); local btnBtn = Instance.new("TextButton", sScroll); btnBtn.Text = "Btn Color"; btnBtn.Size = UDim2.new(0.9, 0, 0, 35); local txtBtn = Instance.new("TextButton", sScroll); txtBtn.Text = "Text Color"; txtBtn.Size = UDim2.new(0.9, 0, 0, 35)
